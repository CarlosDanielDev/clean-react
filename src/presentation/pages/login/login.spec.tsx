...
const simulateForField = (sut: RenderResult, fieldName: string, validationError?: string): void => {
...
describe('Login Component', () => {
  ...
  test('Should start with initial state', () => {
    ...
    simulateForField(sut, 'email', validationError)

    simulateForField(sut, 'password', validationError)
  })
  ...
  test('Should go to signup pages', () => {
    const { sut } = makeSut()
